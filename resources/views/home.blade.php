                    ...
                    <div class="row">
                        <div class="d-flex justify-content-start">
                            <img src="/assets/img/democracy.png" class="rounded d-block" width="100" height="100"
                                alt="voting images">
                            <div class="mx-2">
                                <span class="font-weight-bold text-sm">Election des délégués de niveau {{ $item->niveau .' '. $item->filiere }}</span>
                                <div class="d-flex justify-content-start align-items-center my-1">
                                    <div>
                                        <i class="ni ni-calendar-grid-58 text-primary text-sm opacity-10"></i>
                                    </div>
                                    <span class="nav-link-text ms-2 text-sm">Start date: {{$item->datedebut}}</span>
                                </div>
                                <div class="d-flex justify-content-start align-items-center my-1">
                                    <div>
                                        <i class="ni ni-calendar-grid-58 text-primary text-sm opacity-10"></i>
                                    </div>
                                    <span class="nav-link-text ms-2 text-sm">End date: {{$item->datefin}}</span>
                                </div>
                                <div class="d-flex justify-content-start align-items-center my-1">
                                    <div>
                                        <i class="ni ni-book-bookmark text-primary text-sm opacity-10"></i>
                                    </div>
                                    <span class="nav-link-text ms-2 text-sm">Level: {{ $item->niveau }}</span>
                                </div>
                            </div>
                        </div>
                            <div class="d-flex justify-content-start mt-4 container-fuild">
                                <a   href="{{ route('electeur') }}" type="button" class="btn btn-primary w-100 my-0">Voter</a>
                            </div>
                    </div>
                </div>
            </div>
